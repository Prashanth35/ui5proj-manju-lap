...
/**
 * Adds some clusterContainer to the aggregation <code>clusterContainers</code>.
...
/**
 * Adds some clusterVo to the aggregation <code>clusterVos</code>.
...
/**
 * Attaches event handler <code>fnFunction</code> to the <code>click</code> event of this <code>sap.ui.vbm.ClusterBase</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
...
/**
 * Attaches event handler <code>fnFunction</code> to the <code>contextMenu</code> event of this <code>sap.ui.vbm.ClusterBase</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ui.vbm.ClusterBase</code> itself.
 * 
...
/**
 * Destroys all the clusterContainers in the aggregation <code>clusterContainers</code>.
 * @returns {sap.ui.vbm.ClusterBase} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
...
/**
 * Destroys all the clusterVos in the aggregation <code>clusterVos</code>.
 * @returns {sap.ui.vbm.ClusterBase} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
...
/**
 * Detaches event handler <code>fnFunction</code> from the <code>click</code> event of this <code>sap.ui.vbm.ClusterBase</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs
...
/**
 * Detaches event handler <code>fnFunction</code> from the <code>contextMenu</code> event of this <code>sap.ui.vbm.ClusterBase</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs
 ...
 * Expects the following event parameters:
 * <ul>
 * <li><code>clusterID</code> of type <code>string</code>ID of the clicked cluster object. Can serve as input for GeoMap function getInfoForCluster</li>
 * </ul>
 * @param {Map} [mArguments] The arguments to pass along with the event
 * @returns {sap.ui.vbm.ClusterBase} Reference to <code>this</code> in order to allow method chaining
 * @protected
 * 
 */
sap.ui.vbm.ClusterBase.prototype.fireClick = function(mArguments) { return new sap.ui.vbm.ClusterBase(); };
 ...
 * 
 */
sap.ui.vbm.ClusterBase.prototype.fireContextMenu = function(mArguments) { return new sap.ui.vbm.ClusterBase(); };
...
/**
 * Gets content of aggregation <code>clusterContainers</code>.
 * 
...
/**
 * Gets content of aggregation <code>clusterVos</code>.
 * 
...
/**
 * Gets current value of property <code>textSettings</code>.
 * 
...
/**
 * Checks for the provided <code>sap.ui.vbm.ClusterContainer</code> in the aggregation <code>clusterContainers</code>.
 * and returns its index if found or -1 otherwise.
 * @param {sap.ui.vbm.ClusterContainer}
...
/**
 * Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <code>clusterVos</code>.
 * and returns its index if found or -1 otherwise.
 * @param {sap.ui.core.Control}
...
/**
 * Inserts a clusterContainer into the aggregation <code>clusterContainers</code>.
 * @param {sap.ui.vbm.ClusterContainer}
...
/**
 * Inserts a clusterVo into the aggregation <code>clusterVos</code>.
 * @param {sap.ui.core.Control}
...
/**
 * Removes all the controls from the aggregation <code>clusterContainers</code>.
 * 
 * Additionally, it unregisters them from the hosting UIArea.
...
/**
 * Removes all the controls from the aggregation <code>clusterVos</code>.
 * 
 * Additionally, it unregisters them from the hosting UIArea.
...
/**
 * Removes a clusterContainer from the aggregation <code>clusterContainers</code>.
...
/**
 * Removes a clusterVo from the aggregation <code>clusterVos</code>.
...
/**
 * Gets current value of property <code>enableAnimation</code>.
 * 
...
/**
 * Sets a new value for property <code>centerPosition</code>.
 * 
...
/**
 * Sets a new value for property <code>enableAnimation</code>.
 * 
 * Enable Animation of Map Zoom. Works in combination of setZoomlevel.
 * 
 * When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.
 ...
 * <li>Properties
 * <ul>
 * <li>{@link #getCaption caption} : string (default: ???)</li>
 * </ul>
 * </li>
 * <li>Aggregations
 * <ul>
...
/**
 * Attaches event handler <code>fnFunction</code> to the <code>containerCreated</code> event of this <code>sap.ui.vbm.VBI</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ui.vbm.VBI</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the <code>containerDestroyed</code> event of this <code>sap.ui.vbm.VBI</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ui.vbm.VBI</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the <code>containerCreated</code> event of this <code>sap.ui.vbm.VBI</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs
...
/**
 * Detaches event handler <code>fnFunction</code> from the <code>containerDestroyed</code> event of this <code>sap.ui.vbm.VBI</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs
 ...
 * Expects the following event parameters:
 * <ul>
 * <li><code>contentarea</code> of type <code>object</code>DomRef of placeholder Div for content.</li>
...
/**
 * Fires event <code>containerCreated</code> to attached listeners.
 * 
 * Expects the following event parameters:
 * <ul>
 * <li><code>contentarea</code> of type <code>object</code>DomRef of placeholder Div to render into.</li>
 * <li><code>id</code> of type <code>string</code>ID of the container that was created.</li>
 * </ul>
 * @param {Map} [mArguments] The arguments to pass along with the event
 * @returns {sap.ui.vbm.VBI} Reference to <code>this</code> in order to allow method chaining
 * @protected
 * 
 */
sap.ui.vbm.VBI.prototype.fireContainerCreated = function(mArguments) { return new sap.ui.vbm.VBI(); };

/**
 * Fires event <code>containerDestroyed</code> to attached listeners.
 * 
 * Expects the following event parameters:
 * <ul>
 * <li><code>contentarea</code> of type <code>object</code>DomRef of placeholder Div of content.</li>
 * <li><code>id</code> of type <code>string</code>ID of the container that is destroyed.</li>
 * </ul>
 * @param {Map} [mArguments] The arguments to pass along with the event
 * @returns {sap.ui.vbm.VBI} Reference to <code>this</code> in order to allow method chaining
 * @protected
 * 
 */
sap.ui.vbm.VBI.prototype.fireContainerDestroyed = function(mArguments) { return new sap.ui.vbm.VBI(); };
...
/**
 * Gets current value of property <code>customProperties</code>.
 * 
...
/**
 * Sets a new value for property <code>customProperties</code>.
 * 
 * If you want to add custom data to VO instances and make the GeoMap control aware of it, e.g. for basing clustering rules on it, you
 * can provide an array of property names specifying the keys to consider.
 * 

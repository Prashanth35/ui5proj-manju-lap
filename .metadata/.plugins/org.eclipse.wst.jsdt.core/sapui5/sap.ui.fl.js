...
/**
 * Attaches event handler <code>fnFunction</code> to the <code>cancel</code> event of this <code>sap.ui.fl.transport.TransportDialog</code>.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the <code>ok</code> event of this <code>sap.ui.fl.transport.TransportDialog</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ui.fl.transport.TransportDialog</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the <code>cancel</code> event of this <code>sap.ui.fl.transport.TransportDialog</code>.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the <code>ok</code> event of this <code>sap.ui.fl.transport.TransportDialog</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs
 ...
 * 
 */
sap.ui.fl.transport.TransportDialog.prototype.fireCancel = function(mArguments) { return new sap.ui.fl.transport.TransportDialog(); };
 ...
 * 
 */
sap.ui.fl.transport.TransportDialog.prototype.fireOk = function(mArguments) { return new sap.ui.fl.transport.TransportDialog(); };

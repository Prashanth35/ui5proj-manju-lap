 ...
 * 
 */
sap.uxap.ObjectPageLayout.prototype.fireNavigate = function(mArguments) { return new sap.uxap.ObjectPageLayout(); };
...
/**
 * Gets current value of property <code>sectionTitleLevel</code>.
 * 
...
/**
 * ID of the element which is the current target of the association <code>selectedSection</code>, or <code>null</code>.
 * @returns {sap.ui.core.ID}
 * @since 1.44.0
 * @public
 * 
...
/**
 * Sets a new value for property <code>sectionTitleLevel</code>.
 * 
 * Determines the ARIA level of the <code>ObjectPageSection</code> and <code>ObjectPageSubSection</code> titles.
 * The ARIA level is used by assisting technologies, such as screen readers, to create a hierarchical site map for faster navigation.
 * 
...
/**
 * Sets the associated <code>selectedSection</code>.

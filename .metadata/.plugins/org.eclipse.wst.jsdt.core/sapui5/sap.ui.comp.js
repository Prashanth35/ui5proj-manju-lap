 ...
 * 
 */
sap.ui.comp.filterbar.FilterBar.prototype._addParameter = function(oParameter) {  };
...
/**
 * Attaches event handler <code>fnFunction</code> to the <code>assignedFiltersChanged</code> event of this <code>sap.ui.comp.filterbar.FilterBar</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ui.comp.filterbar.FilterBar</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the <code>initialized</code> event of this <code>sap.ui.comp.filterbar.FilterBar</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ui.comp.filterbar.FilterBar</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the <code>assignedFiltersChanged</code> event of this <code>sap.ui.comp.filterbar.FilterBar</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs
...
/**
 * Detaches event handler <code>fnFunction</code> from the <code>initialized</code> event of this <code>sap.ui.comp.filterbar.FilterBar</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs
 ...
 * 
 */
sap.ui.comp.filterbar.FilterBar.prototype.fireAssignedFiltersChanged = function() {  };
...
/**
 * This method will be called by the smart variant mangement and it indicates, that the standard variant was obtained. It indicates, that the
 * variant management is fulli initialized.
 * @public
 * 
 */
sap.ui.comp.filterbar.FilterBar.prototype.fireInitialized = function() {  };
...
/**
 * Gets current value of property <code>showFilterConfiguration</code>.
 * 
...
/**
 * Gets current value of property <code>useToolbar</code>.
 * 
...
/**
 * Hides the Go button on filter bar. Allows to hide the Go-button for dedicated scenarios, like liveMode.
 * @protected
 * @since 1.40.4
 * 
 */
...
/**
 * Restores the visibility of the Go button on filter bar. The visibilty of the Go button will be set, according to the showGoOnFB property.
 * @protected
 * @since 1.40.4
 * 
 */
...
/**
 * Sets a new value for property <code>useToolbar</code>.
 * 
 * Determines what design should be used. Default is the design with the toolbar. In mobile scenarios this property is ignored - the
 * design with the toolbar will be used.
 * 
...
/**
 * Gets current value of property <code>hiddenFilter</code>.
 * 
...
/**
 * Sets a new value for property <code>hiddenFilter</code>.
 * 
 * A hidden filter will never be visible in the filter bar control
 * 
 * When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.
...
/**
 * Attaches event handler <code>fnFunction</code> to the <code>availableActionsPersonalizationPress</code> event of this <code>sap.ui.comp.navpopover.NavigationPopover</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
...
/**
 * Detaches event handler <code>fnFunction</code> from the <code>availableActionsPersonalizationPress</code> event of this <code>sap.ui.comp.navpopover.NavigationPopover</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs
...
/**
 * Fires event <code>availableActionsPersonalizationPress</code> to attached listeners.
 * @param {Map} [mArguments] The arguments to pass along with the event
 * @returns {sap.ui.comp.navpopover.NavigationPopover} Reference to <code>this</code> in order to allow method chaining
 * @protected
 * @since 1.44.0
 * 
 */
sap.ui.comp.navpopover.NavigationPopover.prototype.fireAvailableActionsPersonalizationPress = function(mArguments) { return new sap.ui.comp.navpopover.NavigationPopover(); };
...
/**
 * Gets current value of property <code>availableActionsPersonalizationText</code>.
 * 
...
/**
 * Sets a new value for property <code>availableActionsPersonalizationText</code>.
 * 
 * Determines the text of personalization link. If this property is set to some string, choosing the personalization link will trigger
 * the <code>availableActionsPersonalizationPress</code> event. If this property is not set, the personalization link is not shown.
 * 
 ...
 * <li><code>semanticAttributesOfSemanticObjects</code> of type <code>object</code>A map of semantic objects for which the navigation targets will be retrieved and it's semantic attributes calculated from
 * the binding context. The semantic attributes will be used as parameters in order to retrieve the navigation targets.</li>
 ...
 * <li><code>popoverForms</code> of type <code>sap.ui.layout.form.SimpleForm[]</code>Array containing contact data.</li>
 ...
 * <li><code>semanticAttributes</code> of type <code>object</code>Map containing the semantic attributes.</li>
 * <li><code>originalId</code> of type <code>string</code>The ID of the NavigationPopoverHandler.</li>
...
/**
 * Gets current value of property <code>additionalSemanticObjects</code>.
 * 
...
/**
 * Gets current value of property <code>contactAnnotationPath</code>.
 * 
...
/**
 * Gets current value of property <code>enableAvailableActionsPersonalization</code>.
 * 
 ...
 * 
 */
sap.ui.comp.navpopover.NavigationPopoverHandler.prototype.openPopover = function() {  };

/**
 * Sets a new value for property <code>additionalSemanticObjects</code>.
 * 
 * Names of additional semantic objects which are used to determine target navigations.
 * 
 * When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.
...
/**
 * Sets a new value for property <code>contactAnnotationPath</code>.
 * 
 * Navigation property that points from the current to the related entity type where the com.sap.vocabularies.Communication.v1.Contact
 * annotation is defined, for example, <code>'to_Supplier'</code>. An empty string means that the related entity type is the
 * current one.
...
/**
 * Sets a new value for property <code>enableAvailableActionsPersonalization</code>.
 * 
 * Determines whether the personalization link is shown inside the NavigationPopover control.
 * 
 * When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.
...
/**
 * Gets current value of property <code>contactAnnotationPaths</code>.
 * 
 * Navigation property that points from the current to the related entity type where the com.sap.vocabularies.Communication.v1.Contact
...
/**
 * Sets a new value for property <code>contactAnnotationPaths</code>.
 * 
 * Navigation property that points from the current to the related entity type where the com.sap.vocabularies.Communication.v1.Contact
 * annotation is defined, for example, <code> '\{"Supplier":"to_Supplier", "CompanyName":"to_Company"\}' </code>. An empty string
 * means that the related entity type is the current one.
...
/**
 * Gets current value of property <code>showChartTooltip</code>.
 * 
...
/**
 * Gets current value of property <code>showDetailsButton</code>.
 * 
...
/**
 * Gets current value of property <code>showDownloadButton</code>.
 * 
...
/**
 * Gets current value of property <code>showDrillBreadcrumbs</code>.
 * 
...
/**
 * Gets current value of property <code>showVariantManagement</code>.
 * 
...
/**
 * ID of the element which is the current target of the association <code>smartVariant</code>, or <code>null</code>.
 * @returns {sap.ui.core.ID}
 * @since 1.38
 * @public
 * 
...
/**
 * Gets current value of property <code>useListForChartTypeSelection</code>.
 * 
...
/**
 * Sets a new value for property <code>showChartTooltip</code>.
 * 
 * Controls the visibility of the chart tooltip. If set to <code>true </code>, the chart tooltip will be shown when hovering over a
 * data point.
 * 
...
/**
 * Sets a new value for property <code>showDetailsButton</code>.
 * 
 * Controls the visibility of the Details button. If set to <code>true</code>, the datapoint tooltip will be disabled as the
 * information of selected datapoints will be found in the details popover. This will also set the drill-down button to invisible.
 * 
...
/**
 * Sets a new value for property <code>showDownloadButton</code>.
 * 
 * Controls the visibility of the chart download button.
 * 
 * When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.
...
/**
 * Sets a new value for property <code>showDrillBreadcrumbs</code>.
 * 
 * Controls the visibility of the Breadcrumbs control for drilling up within the visible dimensions. If set to <code>true</code>,
 * the toolbar header will be replaced by the Breadcrumbs control. This will also set the drill-up button to invisible.
 * 
...
/**
 * Sets a new value for property <code>showVariantManagement</code>.
 * 
 * Controls the visibility of the Variant Management.
 * 
 * When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.
...
/**
 * Sets the associated <code>smartVariant</code>.
...
/**
 * Sets a new value for property <code>useListForChartTypeSelection</code>.
 * 
 * Controls the visualization for chart type selection. If set to <code>true</code>, the list of available chart types will be
 * displayed. If set to <code>false</code> and there are three or fewer available chart types, the chart types will be displayed as
 * separate buttons in the toolbar. If there are more than three chart types, a list will be shown.
...
/**
 * Gets current value of property <code>criticalityRepresentationType</code>.
 * 
...
/**
 * Sets a new value for property <code>criticalityRepresentationType</code>.
 * 
 * Optional attribute, which can be set to control how the criticality is visualized.
 * 
 * When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.
 ...
 * 
 */
sap.ui.comp.smartfield.SmartField.prototype.getAccessibilityInfo = function() {  };
...
/**
 * Gets current value of property <code>clientSideMandatoryCheck</code>.
 * 
...
/**
 * Gets current value of property <code>fetchValueListReadOnly</code>.
 * 
...
/**
 * Sets a new value for property <code>clientSideMandatoryCheck</code>.
 * 
 * Determines if the mandatory check happens on the client side <code>true</code> or on the server side <code>false</code>.
 * 
 * When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.
...
/**
 * Sets a new value for property <code>fetchValueListReadOnly</code>.
 * 
 * Determines whether the SmartField control fetches its value list to display the description for a given key (<code>value</code>
 * property) in read-only mode. If the value list is not fetched by the read-only SmartField control, the application has to make sure
 * that the description is requested and made available, for example, by using $expand. In this case the SmartField control will
 ...
 * Gets current value of property <code>mandatory</code>.
 * 
 * Property can be used to overwrite the mandatory state of a filter field. Property can only be set during initialisation. Changes at
...
/**
 * Gets current value of property <code>considerAnalyticalParameters</code>.
 * 
...
/**
 * Gets current value of property <code>showMessages</code>.
 * 
...
/**
 * Gets current value of property <code>suppressSelection</code>.
 * 
 ...
 * enable an optimal solution when the filter bar is controlled by the smart templates.
 * 
 * Default value is <code>false</code>.
 ...
 * 
 */
sap.ui.comp.smartfilterbar.SmartFilterBar.prototype.search = function() { return false; };
...
/**
 * Sets a new value for property <code>considerAnalyticalParameters</code>.
 * 
 * Indicates if the analytical parameters (SelectionVariant) must be taken into consideration.
 * 
 * When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.
 ...
 * 
 */
sap.ui.comp.smartfilterbar.SmartFilterBar.prototype.setLiveMode = function(bFlag) {  };
...
/**
 * Sets a new value for property <code>showMessages</code>.
 * 
 * If set to <code>false</code> eventual errors during the search, will not be displayed in a messagebox
 * 
 * When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.
...
/**
 * Sets a new value for property <code>suppressSelection</code>.
 * 
 * If set to <code>true</code> all search requests will be ignored. This functionality is only intended to be used internally to
 * enable an optimal solution when the filter bar is controlled by the smart templates.
 * 
...
/**
 * Adds some groupElement to the aggregation <code>groupElements</code>.
...
/**
 * Destroys all the groupElements in the aggregation <code>groupElements</code>.
 * @returns {sap.ui.comp.smartform.Group} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
 ...
 * 
 * Specifies whether the groups shall be rendered in a <code>ResponsiveLayout</code> with label on top of the group element. Each group will be
...
/**
 * Removes all the controls from the aggregation <code>groupElements</code>.
 * 
 * Additionally, it unregisters them from the hosting UIArea.
...
/**
 * Adds some customData into the aggregation <code>customData</code>. Additionally, <code>customData</code> is also added to the <code>SmartField</code> controls in the
 * children hierarchy.
 * @param {sap.ui.core.CustomData} oCustomData the customData to add.
...
/**
 * Updates controls in the hierarchy of a cloned <code>SmartForm</code>.
 * @param {sap.ui.comp.smartform.SmartForm} oSmartForm The cloned smart form
 * @protected
 * 
 */
sap.ui.comp.smartform.SmartForm.prototype._updateClonedElements = function(oSmartForm) {  };
 ...
 * @param {boolean} bConsiderOnlyVisibleGroups Determines if only visible groups are considered; default is true
 * @return {sap.ui.comp.smartfield.SmartField[]} An array of smart fields (might be empty).
 * @public
 * 
 */
sap.ui.comp.smartform.SmartForm.prototype.getSmartFields = function(bConsiderOnlyVisibleGroups) { return new Array(); };
...
/**
 * Attaches event handler <code>fnFunction</code> to the <code>initialize</code> event of this <code>sap.ui.comp.smartmicrochart.SmartAreaMicroChart</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
...
/**
 * Detaches event handler <code>fnFunction</code> from the <code>initialize</code> event of this <code>sap.ui.comp.smartmicrochart.SmartAreaMicroChart</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs
...
/**
 * Fires event <code>initialize</code> to attached listeners.
 * @param {Map} [mArguments] The arguments to pass along with the event
 * @returns {sap.ui.comp.smartmicrochart.SmartAreaMicroChart} Reference to <code>this</code> in order to allow method chaining
 * @protected
 * 
 */
sap.ui.comp.smartmicrochart.SmartAreaMicroChart.prototype.fireInitialize = function(mArguments) { return new sap.ui.comp.smartmicrochart.SmartAreaMicroChart(); };
...
/**
 * ID of the element which is the current target of the association <code>chartDescription</code>, or <code>null</code>.
 * @returns {sap.ui.core.ID}
 * @public
 * 
 */
...
/**
 * ID of the element which is the current target of the association <code>chartTitle</code>, or <code>null</code>.
 * @returns {sap.ui.core.ID}
 * @public
 * 
 */
...
/**
 * ID of the element which is the current target of the association <code>unitOfMeasure</code>, or <code>null</code>.
 * @returns {sap.ui.core.ID}
 * @since 1.38
 * @public
 * 
...
/**
 * Sets the associated <code>chartDescription</code>.
...
/**
 * Sets the associated <code>chartTitle</code>.
...
/**
 * Sets the associated <code>unitOfMeasure</code>.
...
/**
 * Attaches event handler <code>fnFunction</code> to the <code>initialize</code> event of this <code>sap.ui.comp.smartmicrochart.SmartBulletMicroChart</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
...
/**
 * Detaches event handler <code>fnFunction</code> from the <code>initialize</code> event of this <code>sap.ui.comp.smartmicrochart.SmartBulletMicroChart</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs
 ...
 * 
 */
sap.ui.comp.smartmicrochart.SmartBulletMicroChart.prototype.fireInitialize = function(mArguments) { return new sap.ui.comp.smartmicrochart.SmartBulletMicroChart(); };
...
/**
 * Attaches event handler <code>fnFunction</code> to the <code>initialize</code> event of this <code>sap.ui.comp.smartmicrochart.SmartMicroChart</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
...
/**
 * Detaches event handler <code>fnFunction</code> from the <code>initialize</code> event of this <code>sap.ui.comp.smartmicrochart.SmartMicroChart</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs
 ...
 * 
 */
sap.ui.comp.smartmicrochart.SmartMicroChart.prototype.fireInitialize = function(mArguments) { return new sap.ui.comp.smartmicrochart.SmartMicroChart(); };
...
/**
 * ID of the element which is the current target of the association <code>freeText</code>, or <code>null</code>.
 * @returns {sap.ui.core.ID}
 * @since 1.42.0
 * @public
 * 
...
/**
 * Sets the associated <code>freeText</code>.
...
/**
 * Attaches event handler <code>fnFunction</code> to the <code>initialize</code> event of this <code>sap.ui.comp.smartmicrochart.SmartRadialMicroChart</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
...
/**
 * Detaches event handler <code>fnFunction</code> from the <code>initialize</code> event of this <code>sap.ui.comp.smartmicrochart.SmartRadialMicroChart</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs
 ...
 * 
 */
sap.ui.comp.smartmicrochart.SmartRadialMicroChart.prototype.fireInitialize = function(mArguments) { return new sap.ui.comp.smartmicrochart.SmartRadialMicroChart(); };
 ...
 * Gets current value of property <code>entitySet</code>.
 * 
 * The entity set name from from where the data is fetched and and the internal RadialMicroChart representation is created.
 * Note that this is not a dynamic UI5 property.
 * @returns {string} Value of property <code>entitySet</code>
 * @public
 * 
...
/**
 * Destroys the semanticKeyAdditionalControl in the aggregation <code>semanticKeyAdditionalControl</code>.
 * @returns {sap.ui.comp.smarttable.SmartTable} Reference to <code>this</code> in order to allow method chaining
 * @since 1.38.0
 * @public
 * 
...
/**
 * Gets content of aggregation <code>semanticKeyAdditionalControl</code>.
 * 
...
/**
 * Gets current value of property <code>showTablePersonalisation</code>.
 * 
...
/**
 * Sets the aggregated <code>semanticKeyAdditionalControl</code>.
...
/**
 * Sets a new value for property <code>showTablePersonalisation</code>.
 * 
 * The showTablePersonalisation attribute can be set to true or false for controlling the visibility of the TablePersonalisation
 * button.
 * 
...
/**
 * This event is fired when the user selects an item in the items table. The event will only be raised when the dialog gets a table
 * instance from outside via setTable.
 * @event
 * @since 1.32
 * @param {sap.ui.base.Event} oControlEvent
 * @param {sap.ui.base.EventProvider} oControlEvent.getSource
...
/**
 * This event is fired when the user removes one or multiple existing token(s) from the dialog. The event will only be raised when the
 * dialog gets a table instance from outside via setTable.
 * @event
 * @since 1.32
 * @param {sap.ui.base.Event} oControlEvent
 * @param {sap.ui.base.EventProvider} oControlEvent.getSource
...
/**
 * This event is fired when the table gets an update and all existing tokens must be selected in the table. The event will only be
 * raised when the dialog gets a table instance from outside via setTable.
 * @event
 * @since 1.32
 * @param {sap.ui.base.Event} oControlEvent
 * @param {sap.ui.base.EventProvider} oControlEvent.getSource
 ...
 * <li><code>updateTokens</code> of type <code>object[]</code>Returns an array of objects which represents all selected row tokens. The object contains the token key, the row object
 * data from the model, and the information if the token is selected. <code>
 *  [{sKey, oRow, bSelect}, ...]
 *  </code></li>
 ...
 * sap.ui.comp.smartfilterbar.DisplayBehaviour values.
...
/**
 * Sets the array of tokens. The sap.m.Tokens are added to the dialog tokenizer Selected Items or Excluded Items. Normal tokens are added to the
...
/**
 * Gets current value of property <code>author</code>.
 * 
...
/**
 * Sets a new value for property <code>author</code>.
 * 
 * Author of the variant
 * 
 * When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.
...
/**
 * Gets current value of property <code>showSetAsDefault</code>.
 * 
...
/**
 * Sets a new value for property <code>showSetAsDefault</code>.
 * 
 * Indicates that set as default is visible in the Save Variant and the Manage Variants dialogs.
 * 
 * When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.
